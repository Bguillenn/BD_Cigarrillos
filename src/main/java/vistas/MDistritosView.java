 ...
 */
public class MDistritosView extends javax.swing.JFrame {
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Gestiona los registros de distritos en el sistema");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos del distrito"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(cbxDepartamento, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(cbxProvincia, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        cargarProvincias(this.cbxDepartamento.getSelectedIndex());
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        Distrito distrito = distritosController.search( (String) modeloTabla.getValueAt(indexRow, 0));
        EstadoRegistro estReg= estRegController.search(distrito.getEstadoRegistro());
        ...
        this.txtCodigo.setText(distrito.getCodigo());
        this.txtNombre.setText(distrito.getNombre());
    ...
    private void cargarDepartamentos(){
        ...
        for(int i=0; i<departamentos.size();i++)
            if(departamentos.get(i).getEstadoRegistro() != 2)
                this.cbxDepartamento.addItem(departamentos.get(i).getNombre());
        this.cbxDepartamento.setSelectedIndex(0);
    }
    
    private void cargarProvincias(int index){
        this.cbxProvincia.removeAllItems();
        String depCod = this.departamentos.get(index).getCodigo();
        provincias = provinciasController.getAllByDepartamento(depCod);
        for(int i = 0; i < provincias.size(); i++)
            if(provincias.get(i).getEstadoRegistro() != 2)
    ...
    private void cargarTabla(){
        ...
        ArrayList<Distrito> data = distritosController.getAll();
        modeloTabla.setColumnIdentifiers(new Object[]{"Codigo", "Nombre","Provincia" ,"Departamento", "Estado registro"});
        ...
        try{
             for(int i=0; i < data.size(); i++){
                 ...
                 provincia = provinciasController.search(data.get(i).getProvinciaCodigo());
    ...
    private void adicionarNuevo(){
        ...
        int indexDepa = this.cbxDepartamento.getSelectedIndex();
        int indexProv = this.cbxProvincia.getSelectedIndex();
        Distrito distrito = new Distrito(
                codigo+"",
                this.txtNombre.getText(),
                this.provincias.get(indexProv).getCodigo(),
                this.departamentos.get(indexDepa).getCodigo(),
                1
        );
        ControllerResponse resp = distritosController.adiccionar(distrito);
        if(resp.isOk()){
    ...
    private void modificarRegistro(){
        ...
        if(opc == JOptionPane.YES_OPTION){
            Distrito distrito = distritosController.search(this.txtCodigo.getText());
            if(distrito != null){
                int indexDep =this.cbxDepartamento.getSelectedIndex();
                int indexPro = this.cbxProvincia.getSelectedIndex();
                distrito.setNombre(this.txtNombre.getText());
                distrito.setDepartamentoCodigo(this.departamentos.get(indexDep).getCodigo());
                distrito.setProvinciaCodigo(this.provincias.get(indexPro).getCodigo());
                ControllerResponse resp = distritosController.modificar(distrito);
                if(resp.isOk()){
                    JOptionPane.showMessageDialog(this, resp.getMessage(), ventanaTitle, JOptionPane.INFORMATION_MESSAGE);
                    cargarTabla();
                }else{
    ...
    private void eliminarRegistro(){
        ...
        if(opc == JOptionPane.YES_OPTION){
            ControllerResponse resp = distritosController.eliminar(this.txtCodigo.getText());
            if(resp.isOk()){
                JOptionPane.showMessageDialog(this, resp.getMessage(), ventanaTitle, JOptionPane.INFORMATION_MESSAGE);
                cargarTabla();
            }else{
    ...
    private void inactivarRegistro(){
        ...
        if(opc == JOptionPane.YES_OPTION){
            ControllerResponse resp = distritosController.inactivar(this.txtCodigo.getText());
            if(resp.isOk()){
                JOptionPane.showMessageDialog(this, resp.getMessage(), ventanaTitle, JOptionPane.INFORMATION_MESSAGE);
                cargarTabla();
            }else{
    ...
    private void reactivarRegistro(){
        ...
        if(opc == JOptionPane.YES_OPTION){
            ControllerResponse resp = distritosController.reactivar(this.txtCodigo.getText());
            if(resp.isOk()){
                JOptionPane.showMessageDialog(this, resp.getMessage(), ventanaTitle, JOptionPane.INFORMATION_MESSAGE);
                cargarTabla();
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MDistritosView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
